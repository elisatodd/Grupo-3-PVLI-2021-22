 ...
 */
 export default class Puzzle extends Phaser.Scene {
    ...
    option1.on('pointerdown', () => { console.log('no es este'); 
    this.scene.start('gameScene', '0' );}
    );
    option2.on('pointerdown', () => { console.log('no es este'); 
    this.scene.start('gameScene', '0' )}
    );
    option3.on('pointerdown', () => { console.log('no es este'); 
    this.scene.start('gameScene', '0' )}
    );
    option4.on('pointerdown', () => { console.log('este'); 
