...
let config = {
  ...
  scene: [MenuPrincipal,EscenaInicio,  Casa, Plaza, Calle, Bosque, Feria, CasetaFeria, CasaEspejos, Sombrereria, Mercado, Parque, NumerosRasgados,PuzzleCarniceria, PuzzleBanderines, CodigoIndscreto, CartaPuzle, PuzzleTopoz, MenuPausa] // Escenas que requiere el juego
  };
