 ...
 */
 ...
 export default class PuzzleBanderines extends EscenaPuzzle {
    ...
    band1 = {name: 'band1', route: './assets/images/puzzles/b=.png', pos : {x : 0, y : 300}, scaleProportion: 1, functionality : this.Change, image : '', position: 3, id: 1};
    band2 = {name: 'band2', route: './assets/images/puzzles/b2.png', pos : {x : 0, y : 300}, scaleProportion: 1, functionality : this.Change, image : '', position: 1, id: 2};
    band3 = {name: 'band3', route: './assets/images/puzzles/b3.png', pos : {x : 0, y : 300}, scaleProportion: 1, functionality : this.Change, image : '', position: 5, id: 3};
    band4 = {name: 'band4', route: './assets/images/puzzles/b4.png', pos : {x : 0, y : 300}, scaleProportion: 1, functionality : this.Change, image : '', position: 6, id: 4};
    band5 = {name: 'band5', route: './assets/images/puzzles/bx.png', pos : {x : 0, y : 300}, scaleProportion: 1, functionality : this.Change, image : '', position: 2, id: 5};
    band6 = {name: 'band6', route: './assets/images/puzzles/b1.png', pos : {x : 0, y : 300}, scaleProportion: 1, functionality : this.Change, image : '', position: 4, id: 6};
