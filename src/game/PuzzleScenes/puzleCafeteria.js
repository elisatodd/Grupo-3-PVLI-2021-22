...
export default class PuzzleCafeteria extends PuzzleClick {
  ...
  option1 = { name: 'zone1', pos: { x: 1010, y: 575 }, scaleProportion: 10, image: '', functionality: this.Win };
  option2 = { name: 'zone2', pos: { x: 1200, y: 575 }, scaleProportion: 10, image: '', functionality: this.Lose };
  option3 = { name: 'zone3', pos: { x: 1400, y: 575 }, scaleProportion: 10, image: '', functionality: this.Lose };
