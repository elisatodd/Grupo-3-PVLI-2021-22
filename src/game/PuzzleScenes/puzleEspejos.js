...
export default class PuzzleEspejos extends PuzzleClick {
  ...
  text = {name: 'text', route: './assets/images/puzzles/textoLaser.PNG', pos : {x:300, y:100}, scaleProportion: 2};
  acertijo = {name: 'acertijo', route: './assets/images/puzzles/laberintoEspejos.png', pos : {x:700, y:450}, scaleProportion: 1.2};
